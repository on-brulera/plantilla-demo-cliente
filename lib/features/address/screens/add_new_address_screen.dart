                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Container(height: 50.0,
                            ...
                            child: !addressController.isLoading ? CustomButton(
                              ...
                              }else if (_contactPersonEmailController.text.trim().isEmpty && EmailChecker.isNotValid(_contactPersonEmailController.text.trim()) && !Provider.of<AuthController>(context, listen: false).isLoggedIn()) {
